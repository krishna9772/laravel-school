        ...
        <div class="col-md-5 mt-5" id="selectSection">
            <div class="card card-primary">
                <div class="card-header">
                    <div>
                    <h3 class="card-title">Edit Exam Mark</h3>
                    </div>
                </div>
            ...
            {{-- <div id="updateSection"> --}}
                <form id="updateTimeTableForm" style="display: none" class="mt-5" enctype="multipart/form-data">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <div>
                            <h3 class="card-title">Update Exam Mark of <span id="gradeName"></span> <span id="className"></span> </h3>
                            </div>
                        </div>
